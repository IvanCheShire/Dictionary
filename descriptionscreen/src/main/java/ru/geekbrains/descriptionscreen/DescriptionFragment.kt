package ru.geekbrains.descriptionscreen
...
class DescriptionFragment: Fragment(), ru.geekbrains.core.BackButtonListener {

    private val router: Router = getKoin().get()

    companion object {

        private const val DIALOG_FRAGMENT_TAG = "ru.geekbrains.dictionary.view.descriptionscreen.dialogfragmenttag"
        private const val WORD_EXTRA = "ru.geekbrains.dictionary.view.descriptionscreen.wordextra"
        private const val DESCRIPTION_EXTRA = "ru.geekbrains.dictionary.view.descriptionscreen.descriptionextra"
        private const val URL_EXTRA = "ru.geekbrains.dictionary.view.descriptionscreen.urlextra"
